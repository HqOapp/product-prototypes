  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-6 space-y-6">
        <Card>
          <CardHeader>
            <CardTitle>Resource Booking Analytics</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground">This is a placeholder for the Resource Booking analytics page.</p>
            <p className="mt-4">
              This page would typically show analytics related to resource bookings, including room utilization, popular
              booking times, and booking patterns.
            </p>
          </CardContent>
        </Card>
      </div>
